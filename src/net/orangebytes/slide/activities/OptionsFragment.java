...
public class OptionsFragment extends Fragment implements ViewSwitcher.ViewFactory{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mValues = new PuzzleInfo[] 	{ 	new PuzzleInfo("lion", "lion_thumb",10,20), 
        ...
        sk.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {       
		        ...
		        public void onStopTrackingTouch(SeekBar seekBar) {     
		        	...
		        	Animation in = AnimationUtils.loadAnimation(OptionsFragment.this.getActivity(),R.anim.slow_fade_in);
		        	Animation out = AnimationUtils.loadAnimation(OptionsFragment.this.getActivity(),R.anim.slow_fade_out);
		        	mSwitcher.setInAnimation(in);
		        	mSwitcher.setOutAnimation(out);
		        	mSwitcher.setText(getActivity().getString(R.string.grid_size));
		        }       
		        ...
		        public void onStartTrackingTouch(SeekBar seekBar) {  
		        	...
		        	Animation in = AnimationUtils.loadAnimation(OptionsFragment.this.getActivity(),android.R.anim.fade_in);
		        	Animation out = AnimationUtils.loadAnimation(OptionsFragment.this.getActivity(),R.anim.fast_fade_out);
		        	mSwitcher.setInAnimation(in);
		        	mSwitcher.setOutAnimation(out);
		        }       
	...
	public View makeView() {
        ...
        t.setTypeface( Typeface.createFromAsset(getActivity().getAssets(), "Roboto-Light.ttf"));
        return t;
	}
}